classdef cmkf
    ...
    properties(Constant=true)
        Description = 'converted measurements kalman filter';
    end
    properties
    ...
    methods
        %%% constructor
        function obj = cmkf(MotionModel, MeasurementModel)
            switch nargin
                case 1
