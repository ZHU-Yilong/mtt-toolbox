classdef soekf
    ...
    properties(Constant=true)
        Description = 'second order extended kalman filter';
    end
    properties
    ...
    methods
        %%% constructor
        function obj = soekf(MotionModel, MeasurementModel)
            switch nargin
                case 1
