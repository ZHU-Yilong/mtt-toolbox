classdef ukf
    ...
    methods
        %%% constructor
        function obj = ukf(MotionModel, MeasurementModel)
            switch nargin
                case 1
