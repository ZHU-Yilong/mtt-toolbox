classdef vsimm
    ...
    properties(Constant=true)
        Description = 'variable structure interacting multiple model filter';
    end
    properties        
    ...
    methods
        %%% constructor
        function obj = vsimm(MttFilterSet, MatrixPi)
            if nargin>0
        ...
        %%%
        [Xhat, Phat] = filter   (obj, Xinit, Pinit, Minit, Z, MdlSqn, flag)     % filtering algorithm
        [Xhat, Phat] = mcfilter (obj, Xinit, Pinit, Minit, Z, MdlSqn, flag)
    end
