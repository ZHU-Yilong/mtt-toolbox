...
%%
save demo_single_motion_model_singer_alpha.mat
...
legend('真实','CA模型','SI1模型','SI2模型','SI3模型','观测')
% view(3)
...
figure(11)
hold on
% plot(time(3:end),IndexPosRMSE_CV,'-r');
plot(time(3:end),IndexPosRMSE_CA,'-y');
plot(time(3:end),IndexPosRMSE_SI1,'-b');
plot(time(3:end),IndexPosRMSE_SI2,'-c');
plot(time(3:end),IndexPosRMSE_SI3,'-m');
hold off
grid on, box on
xlim([0,TotalTime])
ylim([0,20])
...
figure(12)
hold on
% plot(time(3:end),IndexVelRMSE_CV,'-r');
plot(time(3:end),IndexVelRMSE_CA,'-y');
plot(time(3:end),IndexVelRMSE_SI1,'-b');
plot(time(3:end),IndexVelRMSE_SI2,'-c');
plot(time(3:end),IndexVelRMSE_SI3,'-m');
hold off
grid on, box on
xlim([0,TotalTime])
ylim([0,40])
...
figure(13)
hold on
plot(time(3:end),IndexAccRMSE_CA,'-y');
plot(time(3:end),IndexAccRMSE_SI1,'-b');
plot(time(3:end),IndexAccRMSE_SI2,'-c');
plot(time(3:end),IndexAccRMSE_SI3,'-m');
hold off
grid on, box on
xlim([0,TotalTime])
ylim([0,50])
...
figure(31)
hold on
% plot(time(3:end),IndexPosGAE_CV,'-r');
plot(time(3:end),IndexPosGAE_CA,'-y');
plot(time(3:end),IndexPosGAE_SI1,'-b');
plot(time(3:end),IndexPosGAE_SI2,'-c');
plot(time(3:end),IndexPosGAE_SI3,'-m');
hold off
grid on, box on
xlim([0,TotalTime])
ylim([0,20])
...
figure(32)
hold on
% plot(time(3:end),IndexVelGAE_CV,'-r');
plot(time(3:end),IndexVelGAE_CA,'-y');
plot(time(3:end),IndexVelGAE_SI1,'-b');
plot(time(3:end),IndexVelGAE_SI2,'-c');
plot(time(3:end),IndexVelGAE_SI3,'-m');
hold off
grid on, box on
xlim([0,TotalTime])
ylim([0,40])
...
figure(33)
hold on
plot(time(3:end),IndexAccGAE_CA,'-y');
plot(time(3:end),IndexAccGAE_SI1,'-b');
plot(time(3:end),IndexAccGAE_SI2,'-c');
plot(time(3:end),IndexAccGAE_SI3,'-m');
hold off
grid on, box on
xlim([0,TotalTime])
ylim([0,50])
